...
#if DEBUG
                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.InformationalVersionText)), "Versão informativa" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.InformationalVersionText)),  "Versão + informações de build" },
#endif
