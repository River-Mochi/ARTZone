// File: src/AdvancedRoadTools/Tools/ToolBootstrapSystem.cs
...
namespace AdvancedRoadTools.Tools
{
    ...
    public sealed partial class ToolBootstrapSystem : GameSystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            {
                AdvancedRoadToolsMod.s_Log.Info("[ART] Bootstrap: tool prefab present; nothing to do.");
                m_Done = true;
                Enabled = false;
                return;
            }
            ...
            if (tool != null && tool.GetPrefab() != null)
            {
                AdvancedRoadToolsMod.s_Log.Info("[ART] Bootstrap: tools created.");
                m_Done = true;
                Enabled = false;
                return;
            }
            ...
            {
                AdvancedRoadToolsMod.s_Log.Warn("[ART] Bootstrap: still waiting for Road Services to initialize …");
            }
        }
    }
}
