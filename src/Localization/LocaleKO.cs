    ...
    public sealed class LocaleKO : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> d = new Dictionary<string, string>
            {
                ...
                // Groups
                { m_Settings.GetOptionGroupLocaleID(Setting.kProtectGroup),         "구역 옵션" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.UsageText)),
                    "<새 도로>\n" +
                    "1. 도로 패널을 엽니다(도로 선택).\n" +
                    "2. 도로 도구 패널 아래쪽에서 EZ 아이콘 3개로 양쪽 / 왼쪽만 / 오른쪽만을 선택합니다.\n" +
                    "   선택된 버튼을 다시 클릭하면 없음이 됩니다.\n" +
                    "3. 평소처럼 도로를 그립니다.\n\n" +
                    "-----------------------------------------\n" +
                    ...
                    "   (또는 <왼쪽 위 아이콘> 도 같은 기능).\n" +
                    "2. EZ 아이콘 3개로 양쪽 / 왼쪽만 / 오른쪽만을 선택합니다.\n" +
                    "   선택된 버튼을 다시 클릭하면 없음이 됩니다.\n" +
                    "3. 도로 위에 마우스를 올려 미리보기 합니다.\n" +
                    "4. 빨간 미리보기 = 제거될 셀.\n" +
                    "5. <RMB 순환>: 양쪽 → 왼쪽만 → 오른쪽만 → 없음 → ...\n" +
                    "6. <LMB 한 번>: 적용(확정).\n" +
                    "7. <LMB 누른 채 드래그>하여 여러 도로 구간에 적용한 뒤 놓습니다.\n" +
                    "8. <취소:> 마우스를 밖으로 옮기고 **LMB** 를 놓습니다.\n\n" +
                    "-------------------------------------------\n" +
                    "<선택 버튼>\n" +
